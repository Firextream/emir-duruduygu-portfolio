...
const directusPostsCollection = process.env.DIRECTUS_POSTS_COLLECTION || "posts";
const directusGalleryCollection = process.env.DIRECTUS_GALLERY_COLLECTION || "gallery_images";
const directusPortfolioCollection = process.env.DIRECTUS_PORTFOLIO_COLLECTION || "portfolio_items";
