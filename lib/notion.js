...
function getCloudinaryUrl(notionUrl, options = {}) {
  if (!notionUrl || !notionUrl.startsWith('http')) return notionUrl;
  ...
  return `https://res.cloudinary.com/${CLOUDINARY_CLOUD_NAME}/image/fetch/f_${format},q_${quality},w_${width}/${notionUrl}`;
}
