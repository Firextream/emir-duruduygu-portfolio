...
function getCloudinaryUrl(notionUrl, options = {}) {
  ...
  // Double encode for Cloudinary fetch - handles special characters in Notion URLs
  const encodedUrl = encodeURIComponent(notionUrl);
  return `https://res.cloudinary.com/${CLOUDINARY_CLOUD_NAME}/image/fetch/f_${format},q_${quality},w_${width}/${encodedUrl}`;
}
